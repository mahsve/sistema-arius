				...
				<tbody>
					...
					<tr>
						...
						<td class="py-1 px-2" style="width: 20px;">
							<button type="button" class="btn btn-info btn-sm btn-icon btn_revisar" data-id="{{$servicio->idservicio}}"><i class="fas fa-eye"></i></button>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header border-0 pb-0">
				<h1 class="modal-title text-uppercase fs-5" id="modal_detalles_label"><i class="fas fa-eye"></i> Detalles</h1>
