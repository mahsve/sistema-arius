...
<div class="mb-3">
	<div class="row align-items-center">
		<div class="col-6 text-start">
			<h4 class="card-title text-uppercase my-2"><i class="fas fa-folder-open"></i> Modificar personal</h4>
		</div>
...
<div class="card mb-4">
	<div class="card-body">
		<form class="forms-sample" name="formulario_registro" id="formulario_registro" method="POST" action="{{route('personal.update', ['id' => $personal->cedula])}}">
			@csrf
			@method('PATCH')
			<div class="form-row">
				...
				<div class="form-group col-12 col-lg-6">
					...
					<input type="text" class="form-control text-uppercase" name="c_correo_electronico" id="c_correo_electronico" value="{{$personal->correo}}" placeholder="Ingrese el correo electrónico">
				</div>
				<div class="form-group col-6 col-lg-3">
