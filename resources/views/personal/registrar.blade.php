...
<div class="mb-3">
	<div class="row align-items-center">
		<div class="col-6 text-start">
			<h4 class="card-title text-uppercase m-0">Registrar personal</h4>
		</div>
...
<div class="card mb-4">
	<div class="card-body">
		<form class="forms-sample" name="form-register" id="form-register" method="POST" action="{{route('personal.store')}}">
			@csrf
			...
			<div class="form-row">
				...
				<div class="form-group col-3">
					...
					<input type="text" class="form-control" name="firstname" id="firstname" placeholder="Ingrese los nombres" required>
				</div>
				<div class="form-group col-3">
					<label for="lastname">Apellidos <span class="required">*</span></label>
					<input type="text" class="form-control" name="lastname" id="lastname" placeholder="Ingrese los apellidos" required>
				</div>
