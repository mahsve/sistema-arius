		...
		<form class="forms-sample" name="formulario_registro" id="formulario_registro" method="POST" action="{{route('mapas_de_zonas.store')}}">
			...
			<div class="tab-content border rounded pt-3 pb-0" id="pills-tabContent">
				...
				<div class="tab-pane fade show active" id="pills-cliente" role="tabpanel" aria-labelledby="pills-cliente-tab" tabindex="0">
					<!-- CONTRATO -->
					<div class="row">
						<div class="col-12 col-md-4 col-lg-6 text-start">
					...
					<div class="form-row">
						...
						<div class="form-group col-6 col-md-3 col-lg-3" id="contenedor_identificacion_f">
				...
				<div class="tab-pane fade" id="pills-usuarios" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
					...
					<div class="row align-items-center mb-3">
						<div class="col-12 col-md-6 text-start">
							<h4 class="text-uppercase mb-3 m-md-0"><i class="fas fa-address-card"></i> Usuarios</h4>
						</div>
						<div class="col-12 col-md-6 text-end">
							<div class="form-row justify-content-end">
								<div class="col-12 col-md-6">
									<button type="button" class="btn btn-primary btn-sm w-100" id="btn_agregar_usuario"><i class="fas fa-folder-plus me-2"></i>Agregar usuario</button>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="tab-pane fade" id="pills-zonas" role="tabpanel" aria-labelledby="pills-zonas-tab" tabindex="0">
					...
					<div class="row align-items-center mb-3">
						...
						<div class="col-12 col-md-6 text-end">
							<div class="form-row justify-content-end">
								<div class="col-12 col-md-6">
									<button type="button" class="btn btn-primary btn-sm w-100" id="btn_agregar_zona"><i class="fas fa-folder-plus me-2"></i>Agregar zona</button>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="tab-pane fade" id="pills-tecnicos" role="tabpanel" aria-labelledby="pills-tecnicos-tab" tabindex="0">
					...
					<div class="form-row">
						<div class="form-group col-12 col-md-3 mb-3">
							<label for="m_panel_version" class="d-block text-truncate"><i class="fas fa-file-contract"></i> Panel y versión del sistema</label>
							<input type="text" class="form-control text-uppercase form-tecnicos" name="m_panel_version" id="m_panel_version" placeholder="Ingrese el panel y la versión del sistema">
						</div>
						<div class="form-group col-12 col-md-3 mb-3">
							<label for="m_modelo"><i class="fas fa-file-contract"></i> Modelo </label>
							<input type="text" class="form-control text-uppercase form-tecnicos" name="m_modelo" id="m_modelo" placeholder="Ingrese el panel y la versión">
						</div>
						<div class="form-group col-12 col-md-3 mb-3">
						...
						<div class="form-group col-6 col-md-3 mb-3">
							<label for="m_instalacion" class="d-block text-truncate"><i class="fas fa-file-contract"></i> Fecha de instalación </label>
							<input type="date" class="form-control text-uppercase form-tecnicos" name="m_instalacion" id="m_instalacion">
						</div>
						<div class="form-group col-6 col-md-3 mb-3">
							<label for="m_entrega" class="d-block text-truncate"><i class="fas fa-file-contract"></i> Fecha de entrega </label>
						...
						<div class="form-group col-12 col-md-6 mb-3">
							...
							<select class="form-control text-uppercase form-tecnicos" name="m_asesor" id="m_asesor">
								<option value="">Seleccione</option>
						...
						<div class="form-group col-12 col-md-9 mb-3">
						...
						<div class="form-group col-6 col-md-3 mb-3">
							<label for="m_particiones" class="d-block text-truncate"><i class="fas fa-file-contract"></i> Particiones del sistema</label>
						...
						<div class="form-group col-6 col-md-3 mb-3">
							<label for="m_linea_principal" class="d-block text-truncate"><i class="fas fa-file-contract"></i> Linea principal</label>
						...
						<div class="form-group col-6 col-md-3 mb-3">
							<label for="m_linea_respaldo" class="d-block text-truncate"><i class="fas fa-file-contract"></i> Linea de respaldo</label>
					...
					<div class="row align-items-center mt-2 mb-3">
						...
						<div class="col-12 col-md-6 text-end">
							<div class="form-row justify-content-end">
								<div class="col-12 col-md-6">
									<button type="button" class="btn btn-primary btn-sm w-100" id="btn_agregar_instalador"><i class="fas fa-folder-plus me-2"></i>Agregar técnico</button>
								</div>
							</div>
						</div>
					</div>
