...
<?php
$usuarios = [
	['MARIA EUGENIA PEREZ', '16.292.202', '_', '0412-7736559 SMS'],
	['FRANCO MARTINEZ', '12.090.450', '_', '0416-7229151 SMS'],
];

$zonas = [
	['PUERTA PRINCIPAL', 'DG65', '_'],
	['COCINA', 'DG65', '_'],
	['PUERTA GARAJE', 'CM', '_'],
	['GARAJE', 'DG75', '_'],
	['PATIO', 'DG75', '_'],
...
<page backtop="19mm" backbottom="1mm" backleft="2mm" backright="2mm" style="font-size: 9pt">
	...
	<table border="1" style="width:100%; margin-bottom: 2mm;">
		<tr>
			...
			<td class="bdr-1" style="width: 69.8%;">MARIA EUGENIA PÉREZ</td>
			<td class="bdr-1" style="width: 10.3%;"><b>COD. 2002</b></td>
		</tr>
		<tr>
			<td class="bg-1 bdr-1" style="width: 20%; font-size: 8pt;"><b>DIRECCIÓN:</b></td>
			<td class="bdr-1" colspan="2">M</td>
		</tr>
		<tr>
	...
	<table border="1" style="margin-bottom: 3mm;">
		...
		<?php for ($var = 0; $var < count($usuarios); $var++) { ?>
			<tr>
				<td class="bg-1 bdr-1" style="text-align: right; width: 4%;"><b><?= ($var + 1) ?></b></td>
				<td class="bdr-1" style="width: 36%;"><?= $usuarios[$var][0] ?></td>
				<td class="bdr-1" style="width: 10%;"><?= $usuarios[$var][1] ?></td>
				<td class="bdr-1" style="width: 25%;"><?= $usuarios[$var][2] ?></td>
				<td class="bdr-1" style="width: 25%;"><?= $usuarios[$var][3] ?></td>
			</tr>
		<?php } ?>
		<?php if ($var < 7) { ?>
	...
	<table border="1" style="margin-bottom: 3mm;">
		...
		<?php for ($var = 0; $var < count($zonas); $var++) { ?>
			<tr>
				<td class="bg-1 bdr-1" style="text-align: right; width: 4%;"><b><?= ($var + 1) ?></b></td>
				<td class="bdr-1" style="width: 40%;"><?= $zonas[$var][0] ?></td>
				<td class="bdr-1" style="width: 25%;"><?= $zonas[$var][1] ?></td>
				<td class="bdr-1" style="width: 25%;"><?= $zonas[$var][2] ?></td>
			</tr>
		<?php } ?>
		<?php if ($var < 7) { ?>
			<?php for ($var = $var; $var < 7; $var++) { ?>
				<tr>
					<td class="bg-1 bdr-1" style="text-align: right; width: 4%;"><b><?= ($var + 1) ?></b></td>
					<td class="bdr-1" style="width: 36%;"></td>
					<td class="bdr-1" style="width: 26%;"></td>
					<td class="bdr-1" style="width: 30%;"></td>
				</tr>
			<?php } ?>
		<?php } ?>
	</table>
	...
	<table border="1">
		...
		<tr>
			...
			<td class="bdr-1" colspan="2" rowspan="2" style="width: 50%;">SP4000 TECLADO K636</td>
		</tr>
		<tr>
		...
		<tr>
			<td class="tc bdr-1" colspan="4" style="width: 50%;">MIGUEL VARELA/ JAVIER ALARCON</td>
		...
		<tr>
			...
			<td class="bdr-1" colspan="3">CLOSET - CUARTO PRINCIPAL</td>
		</tr>
		<tr>
