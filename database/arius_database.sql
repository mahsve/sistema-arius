...
CREATE TABLE IF NOT EXISTS `arius_database`.`tb_clientes` (
  ...
  `puntoreferencia` VARCHAR(250) NULL,
...
START TRANSACTION;
USE `arius_database`;
INSERT INTO `arius_database`.`tb_personal` (`cedula`, `nombre_completo`, `telefono1`, `telefono2`, `correo_electronico`, `direccion`, `puntoreferencia`, `idcargo`, `created`, `updated`, `estatus`) VALUES ('V-25791966', 'MIGUEL HERRERA', '(424) 507-1156', NULL, 'MIGUELSOT959@GMAIL.COM', '_', NULL, 1, DEFAULT, DEFAULT, DEFAULT);
...
START TRANSACTION;
USE `arius_database`;
INSERT INTO `arius_database`.`tb_usuarios` (`idusuario`, `cedula`, `usuario`, `contrasena`, `pregunta1`, `respuesta1`, `pregunta2`, `respuesta2`, `created`, `updated`, `estatus`) VALUES (1, 'V-25791966', 'admin', '$2y$10$49nb7Pm3SQUjN.sVuFqD8uGprcI1whJLXV/Z5iFhEvkqgRYw2Z9/6', '-', '-', '-', '-', DEFAULT, DEFAULT, DEFAULT);
