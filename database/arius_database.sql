...
CREATE TABLE IF NOT EXISTS `arius_database`.`tb_usuarios` (
  ...
  `tb_roles_idrol` INT NOT NULL,
  PRIMARY KEY (`idusuario`),
  INDEX `fk_tb_usuarios_tb_personal1_idx` (`cedula` ASC),
  INDEX `fk_tb_usuarios_tb_roles1_idx` (`tb_roles_idrol` ASC),
...
START TRANSACTION;
USE `arius_database`;
INSERT INTO `arius_database`.`tb_usuarios` (`idusuario`, `cedula`, `usuario`, `contrasena`, `pregunta1`, `respuesta1`, `pregunta2`, `respuesta2`, `created`, `updated`, `estatus`, `tb_roles_idrol`) VALUES (1, 'V-25791966', 'admin', '$2y$10$49nb7Pm3SQUjN.sVuFqD8uGprcI1whJLXV/Z5iFhEvkqgRYw2Z9/6', '-', '-', '-', '-', DEFAULT, DEFAULT, DEFAULT, DEFAULT);
