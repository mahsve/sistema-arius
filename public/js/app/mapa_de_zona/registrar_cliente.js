(function () {
	...
	const modal_registrar_cliente = document.getElementById("modal_registrar_cliente") != null ? new bootstrap.Modal('#modal_registrar_cliente') : null;
	...
	if (btn_abrir_registrar_cliente != null) {
	...
	if (c_tipo_identificacion_ != null) {
	...
	// Enviar formulario.
	if (formulario_registro_cl != null) {
	...
	if (btn_abrir_buscar_cliente != null) {
