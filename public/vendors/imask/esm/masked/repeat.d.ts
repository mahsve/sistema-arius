...
import { type FactoryArg, type ExtendFactoryArgOptions, type UpdateOpts } from '../../src/masked/factory';
import MaskedPattern, { type BlockExtraOptions, type MaskedPatternState } from '../../src/masked/pattern';
