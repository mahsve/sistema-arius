...
@section('title', 'Panel principal - ' . env('TITLE'))

@section('scripts')
<script src="{{url('vendors/chart.js/Chart.min.js')}}"></script>
<script src="{{url('js/core/Chart.roundedBarCharts.js')}}"></script>
<script src="{{url('js/core/dashboard.js')}}"></script>
<script src="{{url('js/app/panel/index.js')}}"></script>
@endsection
		...
		<div class="card">
			<div class="card-body">
				<div class="d-sm-flex justify-content-between align-items-start">
					...
					<div>
						<div class="dropdown">
							<button type="button" class="btn btn-secondary dropdown-toggle" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> This month </button>
						...
						<div class="col-lg-12">
							...
							<div class="mt-3">
								<div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
									<div class="d-flex">
										<img class="img-sm rounded-10" src="images/user-default.jpg" alt="profile">
