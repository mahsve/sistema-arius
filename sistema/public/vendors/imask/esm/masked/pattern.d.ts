...
import { type TailDetails } from '../../src/core/tail-details';
import { type Direction } from '../../src/core/utils';
import Masked, { type AppendFlags, type ExtractFlags, type MaskedOptions, type MaskedState } from '../../src/masked/base';
import { type FactoryArg, type ExtendFactoryArgOptions } from '../../src/masked/factory';
import type PatternBlock from '../../src/masked/pattern/block';
import PatternFixedDefinition from '../../src/masked/pattern/fixed-definition';
import PatternInputDefinition from '../../src/masked/pattern/input-definition';
import '../../src/masked/regexp';
