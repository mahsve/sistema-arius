...
import { type ExtendFactoryArgOptions } from '../../src/masked/factory';
import Masked, { type AppendFlags, type MaskedState, type MaskedOptions, type ExtractFlags } from '../../src/masked/base';
